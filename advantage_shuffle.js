...
var advantageCount = function(nums1, nums2) {
    if (nums2.length != nums1.length) return new Array

    let ord = Array.from({length:nums2.length}, (_,i) => i),
        output = new Array(nums2.length),
...
// Output: [24,32,8,12]
console.log(advantageCount([12,24,8], [13,25,32,11]));
// Output: []
